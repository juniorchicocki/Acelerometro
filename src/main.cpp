...
/*******************************************************************************
* Kit Avançado para Arduino v4 - Medindo aceleração e velocidade com MPU-6050
* Mostrar os valores de aceleração linear, velocidade angular, e temperatura de
* um MPU-6050 no Monitor Serial.
*******************************************************************************/
